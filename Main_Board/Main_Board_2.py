...
def ao_clicar_b_pesquisa_aluno():
    os.startfile("002-b-pesquisa_aluno_atalho")
...
img = PhotoImage(file="main_background.png")
label = Label(
    window,
    image=img
)
...
botao_2_b = Button(window, text="Pesquisa", command=ao_clicar_pesquisa_aluno, bg='SeaGreen2')
botao_2_b.place(x=100,y=50)

botao_3 = Button(window, text="Reset", command=ao_clicar_reset_mozila, bg='SeaGreen2')
botao_3.place(x=80,y=20)

botao_4 = Button(window, text="Cadastrar", command=ao_clicar_cadastring_student, bg='SeaGreen2')
botao_4.place(x=240,y=50)

botao_4_b = Button(window, text="Cadastrar", command=ao_clicar_cadastring_student, bg='SeaGreen2')
botao_4_b.place(x=240,y=50)
